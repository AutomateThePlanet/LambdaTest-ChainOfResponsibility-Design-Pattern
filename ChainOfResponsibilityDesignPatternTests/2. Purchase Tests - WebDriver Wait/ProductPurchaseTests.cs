...
namespace DecoratorDesignPattern.SecondVersion;
...
public class ProductPurchaseTests
{
    ...
    public void PurchaseTwoSameProduct()
    {
        ...
        //Thread.Sleep(1000);
        var viewCartButton = _wait.Until(ExpectedConditions.PresenceOfAllElementsLocatedBy(By.XPath("//a[normalize-space(.)='View Cart']"))).Last();
